...
words = ("aardvark", "alligator", "alpaca", "ant", "anteater", "antelope",
         ...
         "chinchilla", "clam", "cobra", "cockroach", "cod", "coyote", "crab",
         "crane", "crocodile", "crow", "curlew", "deer", "dinosaur", "dog", "dogfish",
         "dolphin", "donkey", "dormouse", "dove", "dragonfly", "duck", "dugong",
         ...
         "kangaroo", "kingfisher", "koala", "kudu", "lapwing", "lark",
         ...
         "porcupine", "porpoise", "quail", "quetzal", "rabbit", "raccoon", "rail",
